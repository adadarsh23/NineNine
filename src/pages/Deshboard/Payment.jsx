...
function Payment() {
  return (
    <>
      <div class="bg-white pl-10 m-2">
        <div class="md:max-w-5xl max-w-xl mx-auto">
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 max-md:order-1">
              <h2 class="text-3xl font-bold text-slate-900">Make a payment</h2>
            ...
            <div class="bg-gray-100 p-6 rounded-md">
              <h2 class="text-3xl font-bold text-slate-900">$250.00</h2>
